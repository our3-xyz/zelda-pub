...
contract SimpleNFTs is ERC721Enumerable, Ownable {
    ...
    //  _price is the price of one Punks NFT
     ...
     */
    constructor(string memory baseURI) ERC721("Pacifrope", "PCFR") {
    ...
    function mint() public payable onlyWhenNotPaused {
        require(tokenIds < MAX_TOKEN_ID, "Exceed maximum Punks supply");
